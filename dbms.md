...
## IMP CONCEPTS AND TOPICS
- [advantages of dbms](https://www.geeksforgeeks.org/advantages-of-database-management-system/)
- [All types of dbms keys](https://www.upgrad.com/blog/types-of-keys-in-dbms/)
- [sql joins](https://www.geeksforgeeks.org/sql-join-set-1-inner-left-right-and-full-joins/) || [sql joins examplex yt link](https://youtu.be/Jh_pvk48jHA)
- [ACID Properties](https://www.geeksforgeeks.org/acid-properties-in-dbms/)
- [Indexing , indexing methods](https://www.geeksforgeeks.org/indexing-in-databases-set-1/) || [indexex & indexing yt link](https://youtu.be/fsG1XaZEa78)
